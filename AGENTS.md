...
- [Sessions/Mehrere-Hotels-je-Konto-Plan.md](Sessions/Mehrere-Hotels-je-Konto-Plan.md) — **NÄCHSTER SCHRITT (Phase 6d), vor 6b.** Ein Konto soll mehrere Hotels tragen; `profiles` kann das strukturell nicht (PK = Auth-User, genau ein `hotel_id`). Enthält Zielmodell, Umbauschritte, RLS-Hebel, Risiken, Abnahmekriterien und fünf offene Entscheidungen.
