 ...
 */
export async function ensureRoomTokensAction(slug: string): Promise<{ created?: number; error?: string }> {
 ...
 */
export async function regenerateRoomTokenAction(slug: string, roomId: string): Promise<{ error?: string }> {
