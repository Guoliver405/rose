...
- [ ] **Check-out-Aufstellung im Betrieb prüfen** — 09.09. gebaut (Protokoll: [2026-09-09_Checkout-Aufstellung.md](Sessions/2026-09-09_Checkout-Aufstellung.md)), Migration `2026-09-09_service_orders_abrechnung.sql`. Offen ist der Durchlauf am echten Zimmer: bestellen → erledigt → Check-out mit Summe → Blatt drucken, dazu der Fall „offene Anfrage direkt im Check-out-Kasten abhaken“. Ebenfalls offen und bewusst zurückgestellt: ein Halbsatz im gedruckten Handout, dass kostenpflichtige Leistungen beim Check-out aufgestellt werden — er kostet vier Sprachen auf einem Blatt, das gerade erst auf 230 mm gerechnet wurde.
